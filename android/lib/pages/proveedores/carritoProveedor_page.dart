...
class _CarritoProveedorPageState extends State<CarritoProveedorPage> {
  ...
  void _hacerPedido() async {
    ...
    // Obtener el primer día de reparto desde backend
        ...
        : ListView(
            ...
            children: [
                            ...
                            SizedBox(
                              ...
                              child: TextFormField(
                                ...
                                onChanged: (value) {
                                  ...
                                  setState(() {
                                    _cantidades[producto.id] = parsed.clamp(0, 999);
                                  });
                                },
                              ),
                            ),
              ...
              ElevatedButton.icon(
                ...
                onPressed: () async {
                  final seleccionados = _cantidades.entries
                  ...
                  final productosCarrito = CarritoManager.getProductosDelCarrito(widget.proveedor.id!);

                  final precioTotal = productosCarrito.fold<double>(
                    0.0,
                    (total, p) => total + (p.producto.precioCompra * p.cantidad),
                  );
                  ...
                  if (diaReparto == null) {
                    ScaffoldMessenger.of(context).showSnackBar(
                      const SnackBar(content: Text('El proveedor no tiene día de reparto configurado')),
                    );
                    return;
                  }
