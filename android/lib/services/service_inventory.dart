...
class InventoryApiService {
  ...
  static Future<List<ProductoInventario>> getProductosInventario() async {
    ...
    if (response.statusCode == 200) {
      ...
      throw Exception('Error al obtener los productos de inventario: ${response.body}');
    }
  }
  ...
  static Future<ProductoInventario?> getProductoInventarioById(int id) async {
    ...
    if (response.statusCode == 200) {
      ...
      throw Exception('Error al obtener el producto de inventario: ${response.body}');
    }
  }
  ...
  static Future<ProductoInventario?> getProductoInventarioByName(String name) async {
    ...
    if (response.statusCode == 200) {
      ...
      throw Exception('Error al obtener el producto de inventario por nombre: ${response.body}');
    }
  }
  ...
  static Future<List<ProductoInventario>> getProductosInventarioByCategoria(String categoria) async {
    ...
    if (response.statusCode == 200) {
      ...
      throw Exception('Error al obtener los productos por categoría: ${response.body}');
    }
  }
  ...
  static Future<void> updateProductoInventario(ProductoInventario producto) async {
    ...
    if (response.statusCode != 200) {
      throw Exception('Error al actualizar el producto de inventario: ${response.body}');
    }
  }
  ...
  static Future<void> deleteProductoInventario(int id) async {
    ...
    if (response.statusCode != 204) {
      throw Exception('Error al eliminar el producto de inventario: ${response.body}');
    }
  }
  ...
  static Future<List<ProductoInventario>> getAllProductosInventario() async {
    ...
    if (response.statusCode == 200) {
      ...
      throw Exception('Error al cargar productos de inventario: ${response.body}');
    }
  }
}
